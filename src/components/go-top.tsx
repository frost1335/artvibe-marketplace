...
export default function GoTop() {
    ...
    return (
        <div className={`fixed right-7 z-20 ${show ? "bottom-7 opacity-100" : "-bottom-14 opacity-0"} transition-all duration-300`}>
            <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="flex w-12 h-12 rounded-full bg-indigo-500 items-center justify-center shadow-md dark:border-2 dark:border-white">
